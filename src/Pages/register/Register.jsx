...
const Register = () => {
  ...
  return (
    ...
    <div className="container" style={{width:"25%",maxWidth:"100%",backgroundColor:"white",borderRadius:"5%",opacity:"0.8"}}>
        ...
        <span style={{ color: "red" }}> {error.password} </span>
            ...
            <h3 style={{textAlign:'center'}}>Allready have an account??<Link to='/login' style={{color:'blue'}}>Login</Link></h3><br/>
